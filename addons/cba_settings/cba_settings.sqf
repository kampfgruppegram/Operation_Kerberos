...
ace_arsenal_enableModIcons = false;
...
force ace_repair_repairDamageThreshold_engineer = 0.7;
...
force ace_medical_painCoefficient = 1.55;
force ace_medical_painEffectType = 0;
force ace_medical_painIsOnlySuppressed = true;
force ace_medical_playerDamageThreshold = 1.1;
...
// ACE Nightvision
force ace_nightvision_aimDownSightsBlur = 0.190136;
force ace_nightvision_disableNVGsWithSights = false;
force ace_nightvision_effectScaling = 0.204991;
...
TFAR_takingRadio = 2;
TFAR_Teamspeak_Channel_Name = "Server #1";
TFAR_Teamspeak_Channel_Password = "123";
tfar_terrain_interception_coefficient = 7;
kgg_punch_staminaToRemove = 10;
kgg_punch_hitChance = 0.5;
kgg_punch_unconsciousTimeout = 40;
